...
function maruAssistantMarkup(currentPage){
  ...
  return ''
   ...
   + 'border:0;background:#FEF7EB;color:#143D26;font-size:30px;box-shadow:0 6px 18px rgba(0,0,0,.28);cursor:pointer;z-index:900;'
   ...
   + '.maru-fab img{width:100%;height:100%;object-fit:contain;padding:7px;box-sizing:border-box;border-radius:50%;display:block;animation:maruBob 2.8s ease-in-out infinite;transform-origin:50% 92%;}'
   ...
   + '.maru-head{display:flex;align-items:center;gap:8px;padding:13px 15px;background:linear-gradient(180deg,#0B5A31,#023512);}'
   + '.maru-title{flex:1;font-family:"Kanit";font-weight:800;font-size:16px;color:#F5EAC8;}'
   + '.maru-spk,.maru-x,.maru-set{border:0;background:rgba(255,255,255,.18);width:34px;height:34px;border-radius:50%;font-size:16px;cursor:pointer;color:#F5EAC8;}'
   ...
   + '.maru-hi .mh-av{width:80%;max-width:290px;height:auto;display:block;margin:6px auto 10px;border-radius:14px;filter:drop-shadow(0 4px 9px rgba(120,86,0,.16));}'
   ...
   + '</style>'
   + '<button class="maru-fab" id="maruFab" aria-label="ผู้ช่วยร้าน"><img src="Logo.png" alt="กุยช่าย" onerror="this.replaceWith(document.createTextNode(\'🥟\'))"></button>'
   ...
   +     '<img class="mh-av" src="header.png" alt="กุยช่ายสวรรค์">'
